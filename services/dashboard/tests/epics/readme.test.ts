...
describe('DataEpic', () => {
  ...
  it('Get README Success', () => {
    ...
    expect(store.getActions().slice(1)).toEqual([action(Actions.GET_README_SUCCESS, data)])
  })
})
...
describe('Store tests', () => {
  it('Set state after get README', () => {
    ...
    expect(contentState(defState, action(Actions.GET_README_SUCCESS, data))).toEqual({ ...defState, data })
  })
})
