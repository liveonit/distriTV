...
import { THEMES } from 'src/App/configs';
...
function Dashboard() {
  ...
  const themeMode = modeTheme === THEMES.LIGHT ? 'light' : 'dark'
  return (
    <div>
      <h2>Report</h2>
      <Grid container>
              ...
              <Grid container justifyContent="space-between">
                ...
                <Grid container justifyContent="center" item xs={12} sm={12} md={6}>
                  <div>
                    ...
                    <br />
                    <Chart options={{...options, theme: { mode: themeMode} }}  series={series} type="pie" width={500} />
                  </div>
                </Grid>
              </Grid>
            </Box>
